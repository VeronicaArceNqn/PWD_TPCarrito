...
?>
<script type="text/javascript" src="../js/usuario/asignarRol.js"></script>
        ...
        <div class="col-lg-12">
            <div class="card-body py-5 px-md-5">
                <form class="needs-validation" id="form1" name="form1" method="post">
                    ...
                    <div class="row float-right">
                        ...
                        <?php 
                            if( count($listaRol)>0){
                                ...
                                ?>
                                    <a class="btn btn-success m-2" role="button" href="javascript:void(0)" onclick="darRol(<?php echo $obj->getidrol();?>,<?php echo $datos['idusuario'];?>)">Dar Rol <?php echo $obj->getrodescripcion();?></a>
                                <?php
                                }
                            }
                        ?>
                    ...
                    <!-- Aquí se muestran los roles del Usuario
                        accion/listar_rol.php -->
