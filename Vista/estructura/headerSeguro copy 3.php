		...
		<?php                 
		   ...
		   foreach($objUsuroles as $objusurol){
               $idrol =  $objusurol->getobjrol()->getidrol();
				...
				//echo "<br> LISTA DE MENUROL PARA EL USUARIO --------".$idrol;
					//print_r($objmenurol);
				...
				{  				
				  ...
				  // $idmenu=$objmenurol->getObjMenu()->getIdmenu();
				   //echo "<br> ID MENU ------OK";
				   //print_r($idmenu);
				   if ($objMenu->getMedescripcion()!="#" && $objMenu->getObjMenu()==null){
						?>
						
						<a class="nav-link active" aria-current="page" href="<?php echo $objMenu->getMedescripcion();?>"><?php echo $objMenu->getMenombre();?></a>
				   ...
				   if ($objPadre!=null)
				   {
						$idpadre=$objMenu->getObjMenu()->getIdmenu();
						$idmenu=$objMenu->getIdmenu();
						while ($idpadre == $idmenu){
							?>
							<li class="nav-item">
								<a class="nav-link active" aria-current="page" href="<?php echo $objMenu->getMedescripcion();?>"><?php echo $objMenu->getMenombre();?></a>
							</li>
