...
<body class="easyui-layout">
	<div data-options="region:'north',border:false" style="min-height:250px;height:280px;background:#fff;padding:10px">
		<div id="logo" align="center" style="width: 100%;height: 150px;background-image: url('../css/images/logo-sis-text-2-(800p).png'); background-repeat: no-repeat; background-size: contain; background-position: center center; border: 0px solid black; text-align: center;">
		</div>
		...
		<ul class="nav text-light">
			<?php 
				...
				$arrayMenu = $objAbmMenu->buscar(null);
				//($arrayMenu);

			foreach ($arrayMenu as $menu){
				//echo "<br> LISTA arraymenu ------";
				$res=$menu->getObjMenu();
                   // print_r($res);
				if ($menu->getObjMenu()!=null){
					$idpadre= $menu->getObjMenu();
				//	echo "<br> IDPADRE ------";
				  //  print_r($idpadre->getMenombre());
					
						?>
						<li ><a href="<?php echo $idpadre->getMedescripcion();?>"><?php echo $idpadre->getMenombre(); ?></a>
						<ul>
							<li>
							<a href="<?php echo $menu->getMedescripcion();?>"><?php echo $menu->getMenombre(); ?></a>
							</li>
						</ul>
						</li>
						<?php	
					...
					?>
					<li><a href="<?php echo $menu->getMedescripcion();?>"><?php echo $menu->getMenombre(); ?></a>
					</li>
					<?php
				}
			}			
		...
		<?php 		   
			...
			?>
				...
				<path d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5zM3.14 5l.5 2H5V5H3.14zM6 5v2h2V5H6zm3 0v2h2V5H9zm3 0v2h1.36l.5-2H12zm1.11 3H12v2h.61l.5-2zM11 8H9v2h2V8zM8 8H6v2h2V8zM5 8H3.89l.5 2H5V8zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0z" /></svg> </i>Carrito</a>
				...
				<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4m7 14l5-5l-5-5m5 5H9" /></svg>Salir</a>
