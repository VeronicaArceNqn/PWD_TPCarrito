...
<body class="easyui-layout">
	<div data-options="region:'north',border:false" style="min-height:210px;height:auto;background:#fff;padding:10px">
			...
			<div data-options="region:'center'" style="padding:0px; color:white; width:auto; height:18px;">
				<div class="easyui-layout" data-options="fit:true" >               
					...
					<div data-options="region:'center'" style="background-color:#0d6efd; text-align:end">
							...
							<a href="javascript:void(0)" class="easyui-linkbutton" style="padding:5px; margin:5px; background-color:#212529;color:white;" data-options="plain:true" onclick="cerrarSesion()"><?php echo $nombre.' ('.$rodescrip.')';?> <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
